...
navbar.innerHTML = `
<div class="max-w-7xl mx-auto px-6 lg:px-8 navbar bg-base-100 shadow-sm">
  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0"
        ...
        ${navLinks.map(link => `
          <li>
            <a href="${link.path}" 
               class="${currentPage === link.path ? "font-bold text-indigo-700" : ""}">
              ${link.name}
            </a>
          </li>
        `).join("")}
    ...
    <a href="index.html" class="flex items-center gap-1">
      <span class="text-4xl font-bold text-indigo-700">SwiftCart</span>
    </a>
  </div>
  ...
  <div class="navbar-end">
    <div class="dropdown dropdown-end">
      ...
      <div tabindex="0"
        ...
        <div class="card-body">
          <span class="text-lg font-bold">${cartItems} Items</span>
